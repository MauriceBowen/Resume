...
\end{myframedenv}
\runsubsection{Realizations of Simply Connected Polygonal Linkages}
\descript{| To appear in Springer Verlag, Lecture Notes in Computer Science, September 2015}
\sectionspace
